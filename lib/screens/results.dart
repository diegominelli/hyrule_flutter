...
import 'package:hyrule_flutter/controllers/api_controller.dart';
import 'package:hyrule_flutter/domain/models/entry.dart';
import 'package:hyrule_flutter/screens/components/entry_card.dart';
import 'package:hyrule_flutter/screens/details.dart';
import 'package:hyrule_flutter/screens/favorites.dart';
import 'package:hyrule_flutter/utils/consts/categories.dart';
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemBuilder: (context, index) =>
          EntryCard(entry: entries[index], isSaved: false),
